 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Panel_DRK' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_DRK extends WP_Customize_Panel {
    public $type = 'drk';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_DRK' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_DRK extends WP_Customize_Section {
    public $type = 'drk';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_DRK' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_DRK extends WP_Customize_Control {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        ...
        $visible  = ' drk-dependency-control';
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'drk_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      $class      = ( $is_complex || $custom ) ? ' drk-customize-complex' : '';
      ...
      echo '<div class="drk-customize-field'. esc_attr( $class ) .'"'. $atts .'>';

      DRK::field( $this->field, $this->value(), $this->unique, 'customize' );
