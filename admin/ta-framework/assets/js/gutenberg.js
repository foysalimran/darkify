...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.drk_lite_gutenberg_blocks ) { return; }

  Object.values(window.drk_lite_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'drk_lite-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary drk_lite-shortcode-button',
              onClick: function () {
                window.drk_lite_gutenberg_props = props;
              },
            }, block.button_title ),
