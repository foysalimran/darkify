...
(function($) {
  ...
  function DRK_LITEAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  DRK_LITEAjaxChosen.prototype.init = function() {
  ...
  DRK_LITEAjaxChosen.prototype.events = function() {
  ...
  DRK_LITEAjaxChosen.prototype.search_field_focused = function() {
  ...
  DRK_LITEAjaxChosen.prototype.search_welcome_message = function() {
  ...
  DRK_LITEAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('drk_lite-chosen', _this.options.data).done( function( response ) {
  ...
  DRK_LITEAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.drk_lite-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.DRK_LITEChosenOrder($hidden_value, true);
  ...
  $.fn.DRK_LITEAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new DRK_LITEAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, DRK_LITEAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  DRK_LITEAbstractChosenOrder = (function() {

    function DRK_LITEAbstractChosenOrder() {}

    DRK_LITEAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    DRK_LITEAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    DRK_LITEAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    DRK_LITEAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    DRK_LITEAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    DRK_LITEAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    DRK_LITEAbstractChosenOrder.DRK_LITEChosenOrder = function(select, order, force) {
    ...
    return DRK_LITEAbstractChosenOrder;
  ...
  $.fn.extend({
    DRK_LITEChosenOrder: function(order, force) {
      return _DRK_LITEChosenOrder.DRK_LITEChosenOrder(this, order, force);
    }
  });

  this._DRK_LITEChosenOrder = (function(_super) {
    __extends(_DRK_LITEChosenOrder, _super);

    function _DRK_LITEChosenOrder() {
      _ref = _DRK_LITEChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _DRK_LITEChosenOrder.relAttributeName = 'data-option-array-index';

    _DRK_LITEChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _DRK_LITEChosenOrder.getDOMElement = function(element) {
    ...
    _DRK_LITEChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _DRK_LITEChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _DRK_LITEChosenOrder;

  })(DRK_LITEAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('drk_lite-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('drk_lite-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectDRK_LITE = FormSerializer.serializeObject;
    $.fn.serializeJSONDRK_LITE   = FormSerializer.serializeJSON;
  }
