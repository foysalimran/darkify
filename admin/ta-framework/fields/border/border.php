 ...
 *
 */
if ( ! class_exists( 'DRK_Field_border' ) ) {
  class DRK_Field_border extends DRK_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['all'] ) ) {
        ...
        echo '<input type="number" name="'. esc_attr( $this->field_name( '[all]' ) ) .'" value="'. esc_attr( $value['all'] ) .'"'. $placeholder .' class="drk-input-number drk--is-unit" step="any" />';
        echo ( ! empty( $args['unit'] ) ) ? '<span class="drk--label drk--unit">'. esc_attr( $args['unit'] ) .'</span>' : '';
        echo '</div>';
        ...
        foreach ( $properties as $property ) {
          ...
          echo '<input type="number" name="'. esc_attr( $this->field_name( '['. $property .']' ) ) .'" value="'. esc_attr( $value[$property] ) .'"'. $placeholder .' class="drk-input-number drk--is-unit" step="any" />';
          echo ( ! empty( $args['unit'] ) ) ? '<span class="drk--label drk--unit">'. esc_attr( $args['unit'] ) .'</span>' : '';
          echo '</div>';
