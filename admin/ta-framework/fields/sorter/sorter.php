...
if ( ! class_exists( 'DRK_LITE_Field_sorter' ) ) {
	class DRK_LITE_Field_sorter extends DRK_LITE_Fields {
		...
		public function render() {
			...
			echo '<div class="drk_lite-sorter" data-depend-id="' . esc_attr( $this->field['id'] ) . '"></div>';

			echo ( $args['disabled'] ) ? '<div class="drk_lite-modules">' : '';

			echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="drk_lite-sorter-title">' . esc_attr( $args['enabled_title'] ) . '</div>' : '';
			...
			if ( $args['disabled'] ) {
				...
				echo '<div class="drk_lite-modules">';
				echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="drk_lite-sorter-title">' . esc_attr( $args['disabled_title'] ) . '</div>' : '';
				echo '<ul class="drk_lite-disabled">';
