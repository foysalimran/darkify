 ...
 *
 */
if ( ! class_exists( 'DRK_Field_sorter' ) ) {
  class DRK_Field_sorter extends DRK_Fields {
    ...
    public function render() {
      ...
      echo '<div class="drk-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="drk-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="drk-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="drk-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="drk-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="drk-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="drk-disabled">';
