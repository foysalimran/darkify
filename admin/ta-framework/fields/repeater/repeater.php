	...
	class DRK_LITE_Field_repeater extends DRK_LITE_Fields {
		...
		public function render() {
			...
			if ( preg_match( '/' . preg_quote( '[' . $this->field['id'] . ']' ) . '/', $this->unique ) ) {
				...
				echo '<i class="drk_lite-repeater-remove drk_lite-confirm fas fa-times" data-confirm="' . esc_html__( 'Are you sure to delete this item?', 'chat-skype' ) . '"></i>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
				...
				echo '<div class="drk_lite-repeater-alert drk_lite-repeater-max">' . esc_html__( 'You cannot add more.', 'chat-skype' ) . '</div>';
				echo '<div class="drk_lite-repeater-alert drk_lite-repeater-min">' . esc_html__( 'You cannot remove more.', 'chat-skype' ) . '</div>';
