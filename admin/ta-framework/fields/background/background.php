 ...
 *
 */
if ( ! class_exists( 'DRK_Field_background' ) ) {
  class DRK_Field_background extends DRK_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['background_color'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="drk--title">'. esc_html__( 'From', 'darkify' ) .'</div>' : '';
      ...
      if ( ! empty( $args['background_gradient_color'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="drk--title">'. esc_html__( 'To', 'darkify' ) .'</div>' : '';
      ...
      if ( ! empty( $args['background_gradient_direction'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="drk---title">'. esc_html__( 'Direction', 'darkify' ) .'</div>' : '';
      ...
      if ( ! empty( $args['background_image'] ) ) {
        ...
        echo '<div class="drk--background-image">';

        DRK::field( array(
          'id'          => 'background-image',
          'type'        => 'media',
          'class'       => 'drk-assign-field-background',
      ...
      $auto_class   = ( ! empty( $args['background_auto_attributes'] ) ) ? ' drk--auto-attributes' : '';
      $hidden_class = ( ! empty( $args['background_auto_attributes'] ) && empty( $this->value['background-image']['url'] ) ) ? ' drk--attributes-hidden' : '';

      echo '<div class="drk--background-attributes'. esc_attr( $auto_class . $hidden_class ) .'">';
