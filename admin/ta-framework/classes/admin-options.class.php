...
if ( ! class_exists( 'DRK_LITE_Options' ) ) {
	class DRK_LITE_Options extends DRK_LITE_Abstract {
		...
		public function add_options_html() {
			...
			echo '<div class="drk_lite-form-result drk_lite-form-success ' . esc_attr( $notice_class ) . '">' . esc_html( $notice_text ) . '</div>';

			echo ( $this->args['show_form_warning'] ) ? '<div class="drk_lite-form-result drk_lite-form-warning">' . esc_html__( 'You have unsaved changes, save your changes!', 'chat-skype' ) . '</div>' : '';

			echo ( $has_nav && $this->args['show_all_options'] ) ? '<div class="drk_lite-expand-all" title="' . esc_html__( 'show all settings', 'chat-skype' ) . '"><i class="fas fa-outdent"></i></div>' : '';

			echo ( $this->args['show_search'] ) ? '<div class="drk_lite-search"><input type="text" name="drk_lite-search" placeholder="' . esc_html__( 'Search...', 'chat-skype' ) . '" autocomplete="off" /></div>' : '';

			echo '<div class="drk_lite-buttons">';
			echo '<input type="submit" name="' . esc_attr( $this->unique ) . '[_nonce][save]" class="button button-primary drk_lite-top-save drk_lite-save' . esc_attr( $ajax_class ) . '" value="' . esc_html__( 'Save', 'chat-skype' ) . '" data-save="' . esc_html__( 'Saving...', 'chat-skype' ) . '">';
			echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="drk_lite_transient[reset_section]" class="button button-secondary drk_lite-reset-section drk_lite-confirm" value="' . esc_html__( 'Reset Section', 'chat-skype' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'chat-skype' ) . '">' : '';
			...
			foreach ( $this->pre_sections as $section ) {
				...
				if ( ! empty( $section['fields'] ) ) {
					...
					echo '<div class="drk_lite-no-option">' . esc_html__( 'No data available.', 'chat-skype' ) . '</div>';
				}
			...
			if ( ! empty( $this->args['show_footer'] ) ) {
				...
				echo '<div class="drk_lite-buttons">';
				echo '<input type="submit" name="drk_lite_transient[save]" class="button button-primary drk_lite-save' . esc_attr( $ajax_class ) . '" value="' . esc_html__( 'Save', 'chat-skype' ) . '" data-save="' . esc_html__( 'Saving...', 'chat-skype' ) . '">';
				echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="drk_lite_transient[reset_section]" class="button button-secondary drk_lite-reset-section drk_lite-confirm" value="' . esc_html__( 'Reset Section', 'chat-skype' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'chat-skype' ) . '">' : '';
				echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="drk_lite_transient[reset]" class="button drk_lite-warning-primary drk_lite-reset-all drk_lite-confirm" value="' . ( ( $this->args['show_reset_section'] ) ? esc_html__( 'Reset All', 'chat-skype' ) : esc_html__( 'Reset', 'chat-skype' ) ) . '" data-confirm="' . esc_html__( 'Are you sure you want to reset all settings to default values?', 'chat-skype' ) . '">' : '';
				echo '</div>';

				echo ( ! empty( $this->args['footer_text'] ) ) ? '<div class="drk_lite-copyright">' . esc_html( $this->args['footer_text'] ) . '</div>' : '';
			...
			echo ( ! empty( $this->args['footer_after'] ) ) ? esc_html( $this->args['footer_after'] ) : '';
