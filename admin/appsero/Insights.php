...
class Insights {
    ...
    public function __construct( $client, $name = null, $file = null ) {
        ...
        if ( is_object( $client ) && is_a( $client, 'DarkifyAppSero\Client' ) ) {
            $this->client = $client;
        }
    }
    ...
    public function admin_notice() {
        ...
        if ( empty( $this->notice ) ) {
            $notice = sprintf( $this->client->darkify_trans( 'Want to help make <strong>%1$s</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.' ), $this->client->name );
        } else {
            $notice = $this->notice;
        }
        ...
        $notice .= ' (<a class="' . wp_kses_post($this->client->slug) . '-insights-data-we-collect" href="#">' . $this->client->darkify_trans( 'what we collect' ) . '</a>)';
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . wp_kses_post($this->client->darkify_trans( 'Allow' )) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . wp_kses_post($this->client->darkify_trans( 'No thanks' )) . '</a>';
        echo '</p></div>';
    ...
    private function get_uninstall_reasons() {
        $reasons = array(
			array(
				...
				'text'        => $this->client->darkify_trans( "Couldn't understand" ),
				'placeholder' => $this->client->darkify_trans( 'Would you like us to assist you?' ),
			...
			array(
				...
				'text'        => $this->client->darkify_trans( 'Found a better plugin' ),
				'placeholder' => $this->client->darkify_trans( 'Which plugin?' ),
			...
			array(
				...
				'text'        => $this->client->darkify_trans( "Missing a specific feature" ),
				'placeholder' => $this->client->darkify_trans( 'Could you tell us more about that feature?' ),
			...
			array(
				'id'          => 'is-not-working',
				'text'        => $this->client->darkify_trans( 'Not working' ),
				'placeholder' => $this->client->darkify_trans( 'Could you tell us a bit more whats not working?' ),
			...
			array(
				...
				'text'        => $this->client->darkify_trans( "Not what I was looking" ),
				'placeholder' => $this->client->darkify_trans( 'Could you tell us a bit more?' ),
			...
			array(
				...
				'text'        => $this->client->darkify_trans( "Didn't work as expected" ),
				'placeholder' => $this->client->darkify_trans( 'What did you expect?' ),
			...
			array(
				'id'          => 'other',
				'text'        => $this->client->darkify_trans( 'Others' ),
				'placeholder' => $this->client->darkify_trans( 'Could you tell us a bit more?' ),
    ...
    <div class="wd-dr-modal-wrap">
        ...
        <div class="wd-dr-modal-body">
            ...
            <p class="wd-dr-modal-reasons-bottom">
                <?php
                       echo sprintf(
	                       wp_kses_post($this->client->darkify_trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Appsero handles your data.')),
