...
*  4 floating toggle switcher with lots of customize options
*  Shortcode for toggle switcher
*  Switcher in menu
Preset colors for dark mode can be changed
*  Adjust image brightness, grayscale, background darkening, inversion of inline SVGs for dark mode.
