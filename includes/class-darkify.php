...
class Darkify {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Darkify_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Darkify_Loader. Orchestrates the hooks of the plugin.
	 * - Darkify_i18n. Defines internationalization functionality.
	 * - Darkify_Admin. Defines all hooks for the admin area.
	 * - Darkify_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Darkify_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
